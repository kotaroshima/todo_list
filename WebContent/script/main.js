...
requirejs.config({
    paths: {
        'text': [
            'http://cdnjs.cloudflare.com/ajax/libs/require-text/2.0.3/text'
        ],
        'jQuery': [
        ...
        'Backbone': [
            'http://cdnjs.cloudflare.com/ajax/libs/backbone.js/0.9.9/backbone-min'
        ],
...
define([
    ...
    'TaskListView',
    'EditTaskView'
], function($, _, TaskCollection, TaskListView, EditTaskView){
