...
(function() {
  ...
  define(['jQueryUITouchPunch', 'Sortable', 'TaskCollection', 'TaskView', 'EditTaskView', 'text!template/MainView.html'], function($, Backpack, TaskCollection, TaskView, EditTaskView, viewTemplate) {
