...
(function() {
  ...
  define(['jQueryUITouchPunch', 'Sortable', 'LocalStorage', 'TaskModel', 'TaskView', 'EditTaskView', 'text!template/MainView.html'], function($, Backpack, LocalStorage, TaskModel, TaskView, EditTaskView, viewTemplate) {
