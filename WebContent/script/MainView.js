...
(function() {
  ...
  define(['jQueryUI', 'Underscore', 'Backpack', 'TaskCollection', 'backpack/components/ListView', 'backpack/plugins/Sortable', 'TaskView', 'EditTaskView', 'text!template/MainView.html'], function($, _, Backpack, TaskCollection, ListView, Sortable, TaskView, EditTaskView, viewTemplate) {
