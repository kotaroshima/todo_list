...
(function() {
  ...
  define(['jQueryUI', 'Underscore', 'Backbone', 'TaskCollection', 'ListView', 'plugins/Sortable', 'TaskView', 'EditTaskView', 'text!template/MainView.html'], function($, _, Backbone, TaskCollection, ListView, Sortable, TaskView, EditTaskView, viewTemplate) {
